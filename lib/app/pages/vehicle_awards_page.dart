...
class _VehicleAwardsPageState extends State<VehicleAwardsPage> {
  ...
  Widget _buildAwardCard(VehicleAward award, int index) {
    return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (award.description != null && award.description!.isNotEmpty) ...[
                ...
                Text(
                  award.description!,
                  style: TextStyle(fontSize: 14.sp, color: Colors.grey[300], height: 1.4),
                ),
              ],
            ],
          ),
        ...
        .slideY(begin: 0.3, delay: (100 + (index * 100)).ms, duration: 600.ms, curve: Curves.easeOutCubic);
  }
    ...
    return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [const Color(0xFF1e2340).withOpacity(0.6), const Color(0xFF2a2f4f).withOpacity(0.4)],
            ),
            borderRadius: BorderRadius.circular(16.r),
          ...
          child: Column(
            children: [
              Icon(Icons.emoji_events_outlined, size: 64.sp, color: Colors.grey[500]),
              SizedBox(height: 16.h),
              Text(
                'No Awards Yet',
                style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w600, color: Colors.grey[400]),
              ),
              SizedBox(height: 8.h),
              Text(
              ...
              ElevatedButton.icon(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Add award feature coming soon!'), backgroundColor: Color(0xFF00d4ff)),
                  );
                },
              ...
              Row(
                children: [
                  Container(
                        width: 48.w,
                        height: 48.h,
                        decoration: BoxDecoration(color: Colors.grey[700], borderRadius: BorderRadius.circular(12.r)),
                      )
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w600, color: Colors.red[400]),
                  ),
                  SizedBox(height: 8.h),
                  Text(
                    _error!,
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w600, color: Colors.grey[300]),
                  ),
                  SizedBox(height: 16.h),
                  ...List.generate(_awards.length, (index) => _buildAwardCard(_awards[index], index)),
                ],
              ),
            ),
    );
